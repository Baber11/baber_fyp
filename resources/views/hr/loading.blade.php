							...
							<div class="col-md-6 col-12">
								<div class="">
									<div>
										...
										<p class="video-para" style="color: #e2cf90">
								...
								<div class="d-flex justify-content-end mt-3">
									<div class="p-2">
										<a href="{{route('admin.login')}}">
											<button class="btn_admin">Admin Login</button>
										</a>
									</div>
									<div class="p-2">
										<a href="{{url('/login')}}">
											<button class="btn_admin">HR Login</button>
										</a>
									</div>
								</div>
							</div>
			...
			<section class="bgimg mt-n2">
				<div class="container-fluid">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-3">
								<img src="{{ asset('img/Course1.png') }}" class="img-fluid zoom course_img">
							</div>
							<div class="col-md-3">
								<img src="{{ asset('img/Course2.png') }}" class="img-fluid zoom course_img">
							</div>
							<div class="col-md-3">
								<img src="{{ asset('img/Course3.png') }}" class="img-fluid zoom course_img">
							</div>
							<div class="col-md-3">
								<img src="{{ asset('img/Course4.png') }}" class="img-fluid zoom course_img">
							</div>
						</div>
					</div>
				</section>
				...
				<div class="row">
					<div class="col-md-8">
						<div class="d-flex justify-content-start footer_links" style="">
							...
							<a href="{{url('/about')}}"><div class="mx-1">About Us</div></a>
					...
					<div class="col-md-3">
						<div class="mt-5 pt-5 d-flex justify-content-between">
							<a href="https://www.facebook.com/login.php?next=https%3A%2F%2Fwww.facebook.com%2Frecover"><i class="fab fa-facebook-square fa-2x text-white"></i></a>
							<a href="https://www.linkedin.com/"><i class="fab fa-linkedin fa-2x text-white"></i></a>
							<a href="https://www.instagram.com/"><i class="fab fa-instagram fa-2x text-white"></i></a>
